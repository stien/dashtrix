...
class ico extends CI_Controller {
    ...
    function __construct()
    {
        ...
        $this->data['shufti_url']        = "https://api.shuftipro.com/";
        $this->data['shufti_client_id']  = "1de4d95a81eb1780d5c21a880a8be6595306670af426e40872b2a03c5cfb9996";
        $this->data['shufti_secret_key'] = 'hnb6mF603zXoMP8IjuR5NPR4jC4xkugC'; //Replace with your secret key provided by the Shufti Pro.
...
//                      'uAddress'      => $this->input->post('address'),
            ...
            {
                $_SESSION['wrongsignup'] = $_POST;
                $_SESSION['error'] = "Sorry we don't offer our services in your country.";
                header ( "Location:" . $this->config->base_url ()."signup");
                exit;
            }
    ...
    public function do_register_admin()
    {
        ...
        else
        {
            ...
            foreach($this->input->post('admin_roles') as $role_v)
            {
                $arr = array(
                    'admin_id'=>$uID,
                    'role'=>$role_v,
    ...
    public function add_token_new_price()
    {
        ...
        $data = array(
            ...
            'timezone'          => $this->input->post('timezone')?$this->input->post('timezone'):0,
...
// EMAIL TO USER
    ...
    public function jobsite_forgotpass_recruiter()
    {
        ...
        else
        {
            ...
            $this->email->set_mailtype("html");
            $send = $this->email->send();
            $_SESSION['msglogin'] = 'Your temporary password and secruity code has been sent to your registered email address!';
            //header ( "Location:" . $this->config->base_url () . 'recruiter-login');
            header ( "Location:" . $_SERVER['HTTP_REFERER']);
        }
    }
...
';
            ...
            if(ACTYPE == "2"){
                ...
                if(isset($_POST['hash']))
                {
                    ...
                    $arr = array(
                        ...
                        'tokenPrice'=>$this->data['active_token']->tokenPrice,
                ...
                else
                {
                    ...
                    if($this->data['option']->max_amount && $this->data['option']->max_amount>0 && $arr['amount_paid']>$this->data['option']->max_amount)
                    {
                        ...
                        $_SESSION['error']="You can't pay more than ".$this->data['option']->max_amount." ".$this->data['option']->name.' ('.$this->data['option']->max_amount.' USD)';
                    ...
                    {
                        $_SESSION['error']="You can't pay less than ".$this->data['option']->min_amount." ".$this->data['option']->name.' ('.$this->data['option']->min_amount.' USD)';;
                        redirect($_SERVER["HTTP_REFERER"]);
                        exit;
                    }
                    ...
                    {
                        $_SESSION['error']="You can't invest less than $".$this->data['active_token']->min_invest." (USD) ";
                    ...
                    {
                        $_SESSION['error']="You can't invest more than $".$this->data['active_token']->max_invest." (USD) ";
    ...
    private function do_referrel_work($arr,$uid){
        ...
        $bonues = $arr['tokens'] * ( $get_percentage->tokenawarded/100 );
        ...
        $this->add_balance($my_referrer->uID,$bonues);
        return true;
...

{
    ...
    public function activate_page($id)
    {
         if(!isset($_SESSION['JobsSessions'])){
            ...
            $this->front_model->update_query('dev_web_pages',array('pStatus'=>0),array());
 ...
 check_roles(2);
    ...
    private function handle_demo_verification()
    {
         ...
         $this->data['on_verification_page']=true;
            ...
            // if(!empty($this->data['verification']) && $this->data['verification'][0]->uStatus!=2 && $this->input->post('step')!=2)
            // {
            //     $_SESSION['error']="Sorry, you're not allowed to edit this data because this is being reviewed";
            //     redirect(base_url().'dashboard');
            //     exit;
            ...
            if(isset($_POST['step']))
            {
                ...
                if($_POST['step']==1){
                    ...
                    $url = "https://sandbox.okverify.com/api/customer/create";
    ...
    // db85e9ac7c6a56658ad4d5b01500b607b4909054
                    ...
                    $url = "https://sandbox.okverify.com/api/process/create";
                   ...
                   // print_r($verification_data['document_front_image']);
                   // 
                   // 
                   // 
                   //creating process
                   ...
                   if($document_type==1){
                        ...
                        $url = "https://sandbox.okverify.com/api/identitycard/upload/".$process_idd;
                        ...
                        $url = "https://sandbox.okverify.com/api/identitycardback/upload/".$process_idd;
                    ...
                    if($document_type==2){
                        ...
                        $url = "https://sandbox.okverify.com/api/passport/upload/".$process_idd;
...
// print_r( $post_curl);
                    ...
                    if($document_type==3){
                        ...
                        $url = "https://sandbox.okverify.com/api/driverslicense/upload/".$process_idd;
                        ...
                        else
                        {
                           $r = implode(',', $response);
                                ...
                                $string .= ' Driving License (front): '. $r . '<br>';
                        ...
                        $url = "https://sandbox.okverify.com/api/driverslicenseback/upload/".$process_idd;
...
//                         // print_r($response);
                        ...
                        else
                        {
                           $r = implode(',', $response);
                                ...
                                $string .= ' Driving License (back) '. $r . '<br>';
...
// 
                    ...
                    $post_curl = array(
                         ...
                         $url = "https://sandbox.okverify.com/api/photo/upload/".$process_idd;
                        ...
                        else
                        {
                           $r = implode(',', $response);
                            ...
                            $url = "https://sandbox.okverify.com/api/process/status/".$process_idd;
                            ...
                            $url = "https://sandbox.okverify.com/api/process/result/".$u_uid;
                            $response = $this->demo_post_curl($url,$post_curl,"GET");
    ...
    private function demo_post_curl($url,$curl_post,$type="POST")
    {
        ...
        curl_setopt_array($curl, array(
          ...
          CURLOPT_HTTPHEADER => array(
            "Authorization:Token db85e9ac7c6a56658ad4d5b01500b607b4909054",
            "Referer: ".base_url(),
    ...
    public function add_bonus($id)
    {
        if(!isset($_SESSION['JobsSessions'])){
            ...
            if(ACTYPE==1)
            {
                ...
                {
                    $this->data['id']=$id;
                    $this->load->view('frontend/add_bonus',$this->data);
                }
