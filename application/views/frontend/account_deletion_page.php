...
<!-- Page-Title -->
    <div class="row">
        <div class="col-sm-12 m-b-30">
            ...
            <h4 class="page-title">Request to Delete Profile</h4>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="card-box widget-box-1">
                    ...
                    <h4 class="header-title m-t-0 m-b-30">Request to Delete Profile</h4>
                    <div class="row">


                        
                        <div class="col-md-12 right">
                            <button class="btn btn-default m-t-20 right" type="button" onclick="request_delete_account()">Request</button>
...
function request_delete_account()
{
    var x = confirm("Are you sure you want to delete your account?");
    if(x)
        window.location="<?php echo base_url().'ico/request_delete_account'; ?>";
}
</script>
