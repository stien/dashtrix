f<?php include("common/header.php");?>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                   ...
                   <?php 
						...
						$title = "ADD NEW BOUNTIES LANDING PAGE ITEM - ADMIN";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="title" type="text" class="form-control" required value="<?php  if(isset($_SESSION['wrongsignup'])){echo $_SESSION['wrongsignup']['title'];}?>">
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label>Image <sup>*</sup>&nbsp; <sup>Only 150x150</sup> </label>
