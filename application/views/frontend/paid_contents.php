                ...
                <table  class="table table-actions-bar" id="requests-table" style="margin-bottom: 50px !important;">
                    ...
                    foreach($paid_contents AS $row){
                        ...
                        <tr>
                            ...
                            <td title="<?php echo $user->uCompany?$user->uCompany:$user->uFname.' '.$user->uLname;?>"><?php echo substr( $user->uCompany?$user->uCompany:$user->uFname.' '.$user->uLname,0,20); echo strlen($user->uCompany?$user->uCompany:$user->uFname.' '.$user->uLname>20)?'...':''; ?></td>
                            ...
                            <td>
                                <a href="<?php echo base_url().'admin/download-paid-content/'.$row->id; ?>" target="_blank">
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        if($row->status == "1"){
                                            ?>
                                            <li><a href="javascript:;" onClick="btnstatusupdate(<?php echo $row->id;?>);">Submitted</a></li>

                                        <?php }elseif ($row->status==2) {
                                            ?>
                                            <li><a href="javascript:;" onClick="btnstatusupdate3(<?php echo $row->id;?>);">Completed</a></li>
