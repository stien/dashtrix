    ...
    <div class="col-md-8">
        <form method="POST" action="" accept-charset="UTF-8" id="form-profile">
            ...
            <div class="card-box widget-box-1">
                <h4 class="header-title m-t-0 m-b-30">Edit Publication</h4>
                <div class="row">
                    ...
                    <?php } ?>
                        ...
                        <div class="form-group">
                            <label>Link</label>
                            <input type="url" name="link" value="<?php echo $content->link; ?>" class="form-control" required=""> 
                        </div>
                        <div class="form-group">
                            <label>Price (USD)</label>
                            <input type="number" name="price" step="1"  value="<?php echo $content->price; ?>" class="form-control" required="">
                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="inputfile" <?php echo $content->logo?'':'required'; ?> type="file" accept="image/*" class="form-control"  value="" id="inputfile">
                                            <label class="msg"></label>


                                            <img src="<?php echo  base_url().'resources/uploads/marketing/'.$content->logo; ?>" class="uploading_image <?php echo $content->logo?'':'display_none'; ?>">
