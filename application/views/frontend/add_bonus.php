                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="more_than" type="number" step="1" class="form-control"  required autofocus>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="less_than" type="number" step="1" class="form-control"  required >
                                   ...
                                   <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="bonus" type="number" step="0.5" class="form-control"  required >
