                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <option value="2" <?php if(isset($_SESSION['wrongsignup'])){if($_SESSION['wrongsignup']['type'] == "2"){echo "SELECTED";}}?>>Token Buyer</option>
<?php /* ?>
                                            <option value="2" <?php if(isset($_SESSION['wrongsignup'])){if($_SESSION['wrongsignup']['type'] == "4"){echo "SELECTED";}}?>>Airdrop or Bounty</option>
