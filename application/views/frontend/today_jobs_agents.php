  ...
  <div class="login-inner2 left wd100 jobpost minheightjob" style="margin-right:0;">
    ...
    <table width="100%" id="postedjobs" class="hover" border="0" cellspacing="0" cellpadding="0">
          ...
          <?php
			...
			$usinfo =  $this->front_model->agent_today_jobs(UID);
            ...
            <tr onmouseover="show_hidedata(<?php echo $valuecat->jID; ?>)">
              ...
              <td ><?php echo $valuecat->jCName; ?></td>
              <td ><?php echo date("F, d Y",strtotime($valuecat->jPostedDate)); ?></td>
              <td ><?php echo str_replace(",",", ",$valuecat->jStateCity); ?></td>
              <td ><?php echo $valuecat->jCoutry; ?></td>
              <td ><?php if($valuecat->jDraft == '1')
			  {
