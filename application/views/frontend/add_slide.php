                    ...
                    <div class="tab-content">
                      ...
                      <span class="signupformd"><?php echo $title;?></span>
                        ...
                        <div class="tab-pane active" id="personal">
                            ...
                            <form method="POST" action="<?php echo base_url();?>do/admin/add/slide" accept-charset="UTF-8" id="personal-info">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <option value="1" <?php if(isset($_SESSION['wrongsignup'])){if($_SESSION['wrongsignup']['type'] == "1"){echo "SELECTED";}}?>>Get Data</option>

                                            <option value="2" <?php if(isset($_SESSION['wrongsignup'])){if($_SESSION['wrongsignup']['type'] == "2"){echo "SELECTED";}}?>>Finish</option>
                                    ...
                                    <div class="get-data-div display_none">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <select class="form-control" name="section[]" required="">
                                                            ...
                                                            <?php foreach($links as $link){ ?>
                                                                <option value="<?php echo 'link|'.$link->id; ?>">Link: <?php echo $link->text; ?></option>
                                                            <?php } ?>
                                    ...
                                    <div class="finish-div display_none">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-control" name="finish_question" required="">
