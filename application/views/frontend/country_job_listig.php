...
<div id="loginbx">
  <div class="container">
    ...
    <div class="col-xs-9 nopad">
      <?php
		$arr = array('country_name' => str_replace("-"," ",$this->uri->segment(2)));
	...
	?>
      <div class="login-inner left mabottom5">
        <h2 class="mabottom0">Jobs In - :: - <?php echo $catid[0]->country_name;?></h2>
      </div>
      <?php
		$arr = array('jCoutry' => $catid[0]->id);
	...
	endforeach;
			...
			echo '<div class="infomsg">No Jobs found against country <strong>"'.$catid[0]->country_name.'"</strong>!</div>';
		}
	?>
    </div>
  </div>
