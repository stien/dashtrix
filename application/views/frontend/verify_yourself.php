                   ...
                   <?php $title = "Verify Yourself"; ?>
                      ...
                      <span class="signupformd"><?php echo $title;?></span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>How many tokens are you planning to purchase (<?php
                   ...
                   <?php $title = "Upload Documents"; ?>
                      ...
                      <span class="signupformd"><?php echo $title;?></span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group taking_image">
                                            <label>Selfie with Document Identity / Passport <sup>*</sup>  </label>
                                                <?php echo selfie_doc(1); ?>
                                                <?php echo selfie_doc(); ?>
                                                <a href="javascript:;" onclick="moreSelfie(this);" class="btn btn-xs btn-default easy w-auto">+ More</a>
                                        </div>
                                    </div>
